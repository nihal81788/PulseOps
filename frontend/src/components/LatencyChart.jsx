...
export default function LatencyChart({ monitorId, liveResult }) {
  ...
  const option = {
    ...
    series: [{ type:'line', data: data.map(p => p.ms), smooth:true, symbol:'none', lineStyle: { color:'#3b82f6', width:2 }, areaStyle: { color: { type:'linear', x:0,y:0,x2:0,y2:1, colorStops: [{ offset:0, color:'rgba(59,130,246,0.3)' }, { offset:1, color:'rgba(59,130,246,0)' }] } } }],
  };
